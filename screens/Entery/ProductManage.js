...
import { View, Text, StyleSheet, TextInput, ActivityIndicator, Modal, TouchableOpacity, Button, Image, Alert, KeyboardAvoidingView, ScrollView } from 'react-native';
...
export default class ProductManage extends Component {
  ...
  getData = async () => {
    ...
    return fetch('http://172.20.10.3/myApp/goodSearch.php', {
      ...
      .then((responseJson) => {
        this.setState({
          // data: responseJson,
          g_id: responseJson[0].g_id,
          goodsName: responseJson[0].g_name,
          image: responseJson[0].g_photo,
          m_id: responseJson[0].m_id,
          goodsSelection: responseJson[0].g_category,
          count: responseJson[0].g_quantity, 
          count10: responseJson[0].insertcoins,
          goodsSizeL: responseJson[0].g_sizeL,
          goodsInfo: responseJson[0].g_info, 
          goodsSizeW: responseJson[0].g_sizeW,
          goodsSizeH: responseJson[0].g_sizeH,
          isLoading: false,
        }, function () {
        });
      })
  ...
  submit = () => {
    const { g_id, goodsSelection, count, count10, goodsName, image, goodsSizeL, goodsInfo, goodsSizeW, goodsSizeH, m_id } = this.state;
    if (g_id != null &&goodsSelection != "Default" && count != 0 && count10 != 0 && count10 %10 == 0 && goodsName != null && image != null && goodsSizeL != null && goodsInfo != null && goodsSizeW != null && goodsSizeH) {
      ...
      .then((responseJson) => {
        ...
        fetch('http://172.20.10.3/myApp/goodsModify.php', {
          method: 'POST',
          header: {
            Accept: 'application/json',
            'Contect-type': 'application/json',
        ...
        <ScrollView >
          <KeyboardAvoidingView behavior='padding'>
            <View style={styles.entry}>
                ...
                <View>
                  <Text style={styles.entry_text}>商品編號</Text>
                </View>
                <View>
                  <Text style={styles.text}>{this.state.g_id}</Text>
                </View>
              </View>
              <View style={styles.section}>
                <View>
              ...
              <View style={styles.section}>
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center', flexDirection: 'row' }}>
                  ...
                  <View style={{marginLeft: 12}}>
                    <Image 
                    source={this.state.image != null ? {uri :image} :　require('../../img/picture.png') } 
