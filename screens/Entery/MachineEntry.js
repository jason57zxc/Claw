...
export default class ProductEntry extends Component {
  ...
  submit = () => {
    const { m_name, image, m_address1, count, m_power } = this.state;

    if( count%10 == 0 && count != 0 && m_name != null && image != null &&  m_address1 != null){
      ...
      .then((responseJson) => {
        ...
        fetch('http://172.20.10.3/myApp/machinesEntry.php', {
        method: 'POST',
        header: {
    ...
    else if( count%10 == 0 && count != 0 && m_name != null && image == null &&  m_address1 != null){
      fetch('http://172.20.10.3/myApp/machinesEntry.php', {
        method: 'POST',
        header: {
            Accept: 'application/json',
          ...
          <View style={styles.entry}>
              ...
              <View style={styles.section}>
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center', flexDirection: 'row' }}>
                  ...
                  <View style={{marginLeft: 12}}>
                    <Image 
                    source={this.state.image != null ? {uri :image} :　require('../../img/123.png') } 
            ...
            <View style={styles.section}>
              ...
              <View style={{flexDirection: 'row', marginLeft: 15, alignItems: 'center'}}>
                ...
                {this.state.m_power > 0 ? this.state.m_power: this.state.m_power=0}</TextInput>
                </View>
